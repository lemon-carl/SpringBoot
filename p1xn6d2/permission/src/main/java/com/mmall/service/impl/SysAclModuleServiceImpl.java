...
/**
 * @ClassName : SysAclModuleServiceImpl Created with IDEA
 *
 * @author:CarlLing @CreateDate : 2019-01-23 23:06 @Description : 权限模块业务逻辑
 */
@Service
  ...
  public void save(AclModuleParam param) {
    ...
    SysAclModule aclModule =
        SysAclModule.builder()
            ...
            .build();
    aclModule.setLevel(
        LevelUtil.calculateLevel(getLevel(param.getParentId()), param.getParentId()));
  ...
  void updateWithChild(SysAclModule before, SysAclModule after) {
    ...
    if (!after.getLevel().equals(before.getLevel())) {
      List<SysAclModule> aclModuleList =
          sysAclModuleMapper.getChildAclModuleListByLevel(before.getLevel());
